  ...
  return (
    <main style={{ background: bg, minHeight: "100vh" }} className="pt-24 pb-16 px-4 flex items-center justify-center">
      <div className="max-w-md w-full text-center p-8 rounded-sm" style={{ background: "#111535", border: "1px solid #FFB86B40" }}>
        ...
        <h1 style={{ fontFamily: "var(--font-fuzzy)", color: "#FFB86B", fontSize: "1.5rem" }} className="mb-3">Siparisiniz Alindi!</h1>
        <p style={{ fontFamily: "var(--font-cormorant)", color: "#E9CFE8", lineHeight: 1.8 }}>
          Havale/EFT odemenizi bekliyoruz. Odeme onaylandiktan sonra siparisiniz hazirlanmaya baslayacaktir.
        </p>

        {oid && (
          <div className="mt-4 p-4 rounded-sm" style={{ background: "#0d1130", border: "1px solid #BC6CFF20" }}>
            <p style={{ fontFamily: "var(--font-cinzel)", color: "#BC6CFF80", fontSize: "9px", letterSpacing: "0.1em", marginBottom: "4px" }}>SIPARIS KODU</p>
        ...
        {total && (
          <div className="mt-3 p-4 rounded-sm" style={{ background: "#0d1130", border: "1px solid #BC6CFF20" }}>
            <p style={{ fontFamily: "var(--font-cinzel)", color: "#BC6CFF80", fontSize: "9px", letterSpacing: "0.1em", marginBottom: "4px" }}>ODENECEK TUTAR</p>
            <p style={{ fontFamily: "var(--font-fuzzy)", color: "#FFB86B", fontSize: "1.3rem" }}>TL{Number(total).toLocaleString("tr-TR")}</p>
          </div>
        )}
        ...
        <div className="mt-4 p-4 rounded-sm" style={{ background: "#FFB86B10", border: "1px solid #FFB86B20" }}>
          <p style={{ fontFamily: "var(--font-cormorant)", color: "#FFB86B", fontSize: "0.85rem", lineHeight: 1.6 }}>
            ...
            Hesap Sahibi: Emel Cennetoglu<br />
            IBAN: TR87 0006 7010 0000 0026 4162 88<br />
            <strong>Aciklamaya siparis kodunuzu yazmayi unutmayin.</strong>
          </p>
        </div>
  ...
  return (
    <Suspense fallback={
      <main className="pt-24 pb-16 px-4 flex items-center justify-center" style={{ minHeight: "100vh", background: "#0B0F2B" }}>
        <div className="w-12 h-12 rounded-full animate-spin" style={{ border: "2px solid #BC6CFF30", borderTopColor: "#FFB86B" }} />
      </main>
    }>
      <HavaleContent />
    </Suspense>
