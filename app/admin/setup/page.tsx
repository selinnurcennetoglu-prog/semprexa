      ...
      <main className="admin-fairytale flex items-center justify-center min-h-screen px-6">
        <div className="relative z-10 text-center">
          <div className="fairytale-frame rounded-sm p-10">
            ...
            <h1 style={{ fontFamily: "var(--font-yuyu)", fontSize: "1.8rem", color: "#E21C70" }}>Admin Hesabı Oluşturuldu!</h1>
            <p style={{ fontFamily: "var(--font-fuzzy)", color: "#872D72" }} className="my-4">✦ Artık admin olarak giriş yapabilirsiniz ✦</p>
    ...
    <main className="admin-fairytale flex items-center justify-center min-h-screen px-6">
      <div className="relative z-10 max-w-lg w-full">
        <div className="text-center mb-12">
          ...
          <h1 style={{ fontFamily: "var(--font-yuyu)", fontSize: "2.5rem", color: "#E21C70" }}>Admin Hesabı Oluştur</h1>
          <p style={{ fontFamily: "var(--font-fuzzy)", color: "#872D72" }} className="mt-2">✦ İlk kurulum ✦</p>
        </div>
        ...
        <p className="text-center mt-8" style={{ fontFamily: "var(--font-fuzzy)", color: "#872D72" }}>
          <Link href="/admin/giris" className="hover:underline" style={{ color: "#E21C70" }}>Admin Girişi</Link>
        </p>
      </div>
    </main>
  );
